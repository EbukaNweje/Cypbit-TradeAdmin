...
const ManageWithdrawal = () => {
  ...
  const sendSignUpEmail = async (id) => {
    const urlemail = `https://cypbit-tradebackend.onrender.com/api/confirmwithdrawalemailsend/${id}`
    axios.post(urlemail)
       .then(response => {
    ...
    const acceptDeposit = (withdrawId) => {
        const url = `https://cypbit-trade-back-e-nd-ashen.vercel.app/api/confirm-withdrawal/${withdrawId}`;
        axios.post(url)
            .then((response) => {
    ...
    const getallDeposit = () => {
        const url = "https://cypbit-trade-back-e-nd-ashen.vercel.app/api/allwithdrawal";
        axios.get(url)
            .then((response) => {
